...
import imagesquare4 from "../../assets/imagesquare4.png";
        ...
        <div className={styles.infoDivs}>
          ...
          <div className={styles.imagesContainer}>
            <div className={styles.imageWrapper}>
              <img src={imagesquare1} alt="event" />
            ...
            <div className={styles.imageWrapper}>
              <img src={imagesquare2} alt="event" />
              <div className={styles.linkLayer}>
                <div className={styles.iconWrapper}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
            ...
            <div className={styles.imageWrapper}>
              <img src={imagesquare3} alt="event" />
              <div className={styles.linkLayer}>
                <div className={styles.iconWrapper}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
            ...
            <div className={styles.imageWrapper}>
              <img src={imagesquare4} alt="event" />
              <div className={styles.linkLayer}>
                <div className={styles.iconWrapper}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
            ...
            <div className={styles.imageWrapper}>
              <img src={imagesquare5} alt="event" />
              <div className={styles.linkLayer}>
                <div className={styles.iconWrapper}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
            ...
            <div className={styles.imageWrapper}>
              <img src={imagesquare6} alt="event" />
              <div className={styles.linkLayer}>
                <div className={styles.iconWrapper}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
          ...
          <h3>
            Follow our Instagram <strong style={{color:"#ffbe30"}}>#Harmoni</strong>
          </h3>
        </div>
      </footer>
      <footer className={styles.layer2}>
